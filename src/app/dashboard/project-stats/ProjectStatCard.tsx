import type {IProjectStat} from "@/app/dashboard/project-stats/project-stats.types";
import cn from "clsx";
        ...
        >
            <div className="flex items-center justify-between relative z-10">
                <div className="flex flex-col">
                    <span className="text-4xl font-semibold mb-1">{projectStat.id === 3 ? formatMinutes(projectStat.number) : projectStat.number}</span>
